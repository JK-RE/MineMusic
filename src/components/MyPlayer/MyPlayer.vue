        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-left" :class="songCanplay ? '' : 'disable'">
              <i @click="prevSong" class="iconf-prev"></i>
            </div>
            <div class="icon i-center" :class="songCanplay ? '' : 'disable'">
              <i @click="togglePlaying" :class="playing ? 'iconf-pause' : 'iconf-play'"></i>
            </div>
            <div class="icon i-right" :class="songCanplay ? '' : 'disable'">
              <i @click="nextSong" class="iconf-next"></i>
            </div>
      ...
      <div @click="open" v-show="!fullScreen" class="mini-player">
        ...
        <div class="control">
          ...
          <my-progress-circle :percent="percent" :radius="32">
            <i @click.stop="togglePlaying" :class="playing ? 'iconf-pause-mini' : 'iconf-play-mini'" class="icon-mini"></i>
          </my-progress-circle>
        </div>

        <div class="control" @click.stop="showPlaylist">
          <i class="iconf-playlist"></i>
        </div>
      </div>
    </transition>
...
export default {
  ...
  methods: {
    ...
    getFavoriteCls(song) {
      if (this._isFavorite(song)) {
        return 'iconf-favorite'
      } else {
        return 'iconf-not-favorite'
      }
    },
    _isFavorite(song) {
...
.my-player {
  ...
  .mini-player {
    ...
    .control {
      ...
      width: 30px;
      padding: 0 10px;
      .iconf-play-mini, .iconf-pause-mini, .iconf-playlist {
        font-size: 30px;
        color: $color-text-ll;
      }
      .icon-mini {
